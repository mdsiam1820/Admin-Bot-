...
// লাস্ট ট্রিগার টাইম স্টোর করতে (স্প্যাম প্রতিরোধ
const lastTriggered = {};
...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = [
    ...
    "আমাকে না ডেকে আমার বস সিয়াম কে একটা জি এফ দাও-😽🫶🌺",
    ...
    "চুনা ও চুনা আমার বস সিয়াম এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না😪🤧😭",
    ...
    "আমার বস আলভী চৌধুরী'র পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস আলভী চৌধুরী'র জন্য দোয়া করবেন-💝💚🌺🌻",
    "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস সিয়াম এর নবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/hafiz.siam.ahmed",
    ...
    "-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস সিয়াম কে-🐸😾🔪",
    ...
    "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস সিয়াম ধরতে পারছে না-🐸🥲",
    ...
    "সুন্দর মাইয়া মানেই-🥱আমার বস সিয়াম' এর বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
    ...
    "-ওই বেডি তোমার বাসায় না আমার বস সিয়াম মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂-আমার বস সিয়াম কে জানে মারার কি দরকার-🙄🤧",
    ...
    "মেয়ে হলে বস সিয়াম 'এর সাথে প্রেম করো🙈??.",
    "আরে Bolo আমার জান ,কেমন আসো?😚",
    "Bot বলে অসম্মান করচ্ছিছ,😰😿",
    "Hop bedi😾,Boss বল boss😼",
    "চুপ থাক ,নাই তো তোর দাত ভেগে দিবো কিন্তু",
    "Bot না , জানু বল জানু 😘",
    "বার বার Disturb করেছিস কোনো😾,আমার বস সিয়াম এর এর সাথে ব্যাস্ত আসি😋",
    ...
    "হা বলো, শুনছি আমি 😏",
    "আর কত বার ডাকবি ,শুনছি তো",
    "মাইয়া হলে আমার বস সিয়াম কে Ummmmha দে 😒",
    "বলো কি করতে পারি তোমার জন্য",
    "আমি তো অন্ধ কিছু দেখি না🐸 😎",
    "Bot না জানু,বল 😌",
    "বলো জানু 🌚",
    "তোর কি চোখে পড়ে না আমি বস সিয়াম এর সাথে ব্যাস্ত আসি😒",
    ...
    "- দুনিয়ার সবাই প্রেম করে.!🤧 -আর মানুষ আমার বস সিয়াম কে সন্দেহ করে.!🐸",
    ...
    "- থাপ্পড় চিনোস থাপ্পড়- 👋👋😡 -চিন্তা করিস না তরে মারমু না-🤗 -বস সিয়াম আমারে মারছে - 🥱 - উফফ সেই স্বাদ..!🥵🤤💦",
  ...
  // চেক করবে যদি ইতিমধ্যে রিপ্লাই দেওয়া হয়ে থাকে (স্প্যাম প্রতিরোধ)
  const now = Date.now();
  const lastTime = lastTriggered[threadID] || 0;
  if (now - lastTime < 3000) { // ৩ সেকেন্ড কুলডাউন
    return;
  }
  lastTriggered[threadID] = now;

  // স্পেসিফিক কমান্ড চেক (যেমন: "miss you", "help", ইত্যাদি)
  if ((body.toLowerCase() == "miss you") || (body.toLowerCase() == "miss you")) {
    return api.sendMessage("<আমি তোমাকে রাইতে মিস খাই🥹🤖👅/👅-✘  🎀 🍒:))", threadID);
  }

  if ((body.toLowerCase() == "😘") || (body.toLowerCase() == "😽")) {
  ...
  if ((body.toLowerCase() == "sim") || (body.toLowerCase() == "simsimi")) {
    return api.sendMessage("simsimi কমান্ড এড় নাই টাইপ করুন baby", threadID);
  }

  if ((body.toLowerCase() == "ওই কিরে") || (body.toLowerCase() == "oi keray") || (body.toLowerCase() == "...") || (body.toLowerCase() == "...")) {
    return api.sendMessage("মধু মধু রসমালাই 🍆⛏️🐸🤣", threadID);
  }

  if ((body.toLowerCase() == "bc") || (body.toLowerCase() == "mc")) {
  ...
  if ((body.toLowerCase() == "morning") || (body.toLowerCase() == "good morning")) {
    return api.sendMessage("GOOD MORNING দাত ব্রাশ করে খেয়ে নেও😚", threadID);
  }

  if ((body.toLowerCase() == "tor ball") || (body.toLowerCase() == "bal")) {
    return api.sendMessage("~ তোমার বাল উঠে নাই নাকি তোমার?? 🤖", threadID);
  }

  if ((body.toLowerCase() == "siam") || (body.toLowerCase() == "siam bai") || (body.toLowerCase() == "@siam ッ") || (body.toLowerCase() == "সিয়াম")) {
    return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘", threadID);
  }

  if ((body.toLowerCase() == "owner") || (body.toLowerCase() == "ceo")) {
    return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Siam ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Siam.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/hafiz.siam.ahmed\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01X75X82X02X8", threadID);
  }

  if ((body.toLowerCase() == "tor boss ke") || (body.toLowerCase() == "admin ke ")) {
    return api.sendMessage("My Creator: SIAM ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস সিয়াম আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
  }

  if ((body.toLowerCase() == "admin") || (body.toLowerCase() == "boter admin")) {
    return api.sendMessage("He is Siam ッ❤️ তাকে সবাই সিয়াম নামে  চিনে🤙", threadID);
  }

  if ((body.toLowerCase() == "ai") || (body.toLowerCase() == "Ai")) {
    return api.sendMessage("If you want to use the AI command, type /ai ", threadID);
  }

  if ((body.toLowerCase() == "chup") || (body.toLowerCase() == "stop") || (body.toLowerCase() == "চুপ কর") || (body.toLowerCase() == "chup kor")) {
    return api.sendMessage("তুই চুপ চুপ কর পাগল ছাগল", threadID);
  }

  if ((body.toLowerCase() == "আসসালামু আলাইকুম") || (body.toLowerCase() == "assalamualaikum") || (body.toLowerCase() == "assalamu alaikum") || (body.toLowerCase() == "salam ")) {
    return api.sendMessage("️- ওয়ালাইকুমুস-সালাম-!!🖤", threadID);
  }

  if ((body.toLowerCase() == "sala ami tor boss") || (body.toLowerCase() == "sala ami siam") || (body.toLowerCase() == "cup sala ami siam") || (body.toLowerCase() == "madari")) {
    return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
  }

  if ((body.toLowerCase() == "@farhana ontora") || (body.toLowerCase() == "@farhana ontora ")) {
    return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস সিয়াম এর বউ এর আইড়ি😠🥰⛏️", threadID);
  }

  if ((body.toLowerCase() == "farhana") || (body.toLowerCase() == "arohi")) {
    return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিয়াম এর বউ এর নাম..!😠🥰⛏️", threadID);
  }

  if ((body.toLowerCase() == "mim") || (body.toLowerCase() == "Mim")) {
    return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিয়াম এর বউ এর নাম..!😠🥰⛏️", threadID);
  }

  if ((body.toLowerCase() == "arohi") || (body.toLowerCase() == "farhana")) {
    return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিয়াম এর বউ এর নাম..!😠🥰⛏️", threadID);
  }

  if ((body.toLowerCase() == "@md shiam tafeder ") || (body.toLowerCase() == "সিয়াম")) {
    return api.sendMessage("🥰-সিয়াম-🌺 আমার বস সিয়াম বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
  }

  if ((body.toLowerCase() == "kiss me") || (body.toLowerCase() == "kiss me")) {
    return api.sendMessage("️ তুমি পঁচা তোমাকে কিস দিবো না 🤭", threadID);
  }

  if ((body.toLowerCase() == "tnx") || (body.toLowerCase() == "ধন্যবাদ") || (body.toLowerCase() == "thank you") || (body.toLowerCase() == "thanks")) {
    return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
  }

  if ((body.toLowerCase() == "....") || (body.toLowerCase() == "...") || (body.toLowerCase() == "😠") || (body.toLowerCase() == "🤬") || (body.toLowerCase() == "😾")) {
    return api.sendMessage("️রাগ করে না সোনা পাখি এতো রাগ শরীরের জন্য ভালো না🥰", threadID);
  }

  if ((body.toLowerCase() == "হুম") || (body.toLowerCase() == "hum")) {
    return api.sendMessage("️হুম চোদাইস না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
  }

  if ((body.toLowerCase() == "name") || (body.toLowerCase() == "name") || (body.toLowerCase() == "tor nam ki")) {
    return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁", threadID);
  }

  if ((body.toLowerCase() == "bot er baccha") || (body.toLowerCase() == "bot er bacca")) {
    return api.sendMessage("️আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️🌶️ ", threadID);
  }

  if ((body.toLowerCase() == "pic de") || (body.toLowerCase() == "ss daw")) {
    return api.sendMessage("️এন থেকে সর দুরে গিয়া মর😒", threadID);
  }

  if ((body.toLowerCase() == "moriom") || (body.toLowerCase() == "ex")) {
    return api.sendMessage("️Kiss Randi Ka Name Le Ke Mood Khrab Kr Diya.🙄 Dubara Naam Mat Lena Iska", threadID);
  }

  if ((body.toLowerCase() == "cudi") || (body.toLowerCase() == "tor nanire xudi")) {
  ...
  if ((body.toLowerCase() == "amake kew valobashe na") || (body.toLowerCase() == "amake kew valobashe na") || (body.toLowerCase() == "aj kew nai bole")) {
    return api.sendMessage("️চিন্তা করো কেন আমি তো আছি🫶/nতোমাকে রাইতে ভালোবাসবো", threadID);
  }

  if ((body.toLowerCase() == "gf") || (body.toLowerCase() == "bf")) {
    return api.sendMessage("খালি কি তোরাই পেম করবি আমাকেও একটা গফ দে<🥺", threadID);
  }

  if ((body.toLowerCase() == "😂") || (body.toLowerCase() == "😁") || (body.toLowerCase() == "😆") || (body.toLowerCase() == "🤣") || (body.toLowerCase() == "😸") || (body.toLowerCase() == "😹")) {
    return api.sendMessage("ভাই তুই এত হাসিস না হাসলে তোরে চোরের মত লাগে..!🌚🤣", threadID);
  }

  if ((body.toLowerCase() == "🥰") || (body.toLowerCase() == "😍") || (body.toLowerCase() == "😻") || (body.toLowerCase() == "❤️")) {
    return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে  ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
  }

  if ((body.toLowerCase() == "কেমন আছো") || (body.toLowerCase() == "কেমন আছেন") || (body.toLowerCase() == "kmon acho") || (body.toLowerCase() == "how are you") || (body.toLowerCase() == "how are you?")) {
    return api.sendMessage("আমি তখনই ভালো থাকি যখন আপনাকে হাসতে দেখি🤎☺️", threadID);
  }

  if ((body.toLowerCase() == "mon kharap") || (body.toLowerCase() == "tmr ki mon kharap")) {
    return api.sendMessage("আমার সাদা মনে কোনো কাদা নাই...!🌝", threadID);
  }

  if ((body.toLowerCase() == "i love you") || (body.toLowerCase() == "love you") || (body.toLowerCase() == "I Love You") || (body.toLowerCase() == "ভালোবাসি") || (body.toLowerCase() == "i love you")) {
    return api.sendMessage("সব মুতার জায়গায় গুঁতা দেওয়ার ধান্দা 😪🥱", threadID);
  }

  if ((body.toLowerCase() == "by") || (body.toLowerCase() == "bye") || (body.toLowerCase() == "jaiga") || (body.toLowerCase() == "বাই") || (body.toLowerCase() == "pore kotha hbe") || (body.toLowerCase() == "যাই গা")) {
    return api.sendMessage("কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️🍆⛏️", threadID);
  }

  if ((body.toLowerCase() == "tumi khaiso") || (body.toLowerCase() == "khaicho")) {
    return api.sendMessage("না ঝাং 🥹 তুমি রান্না করে রাখো আমি এসে খাবো <😘", threadID);
  }

  if ((body.toLowerCase() == "tumi ki amake bhalobaso") || (body.toLowerCase() == "tmi ki amake vlo basho")) {
    return api.sendMessage("হুম ঝাং আমি তোমাকে রাইতে ভলোপাসি <🥵", threadID);
  }

  if ((body.toLowerCase() == "ami siam") || (body.toLowerCase() == "kire")) {
    return api.sendMessage("হ্যা বস কেমন আছেন..?☺️", threadID);
  }

  // মূল "bot" ট্রিগার (শুধুমাত্র একবার রিপ্লাই দেবে)
