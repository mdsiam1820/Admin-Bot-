module.exports.config = {
 ...
 version: "1.0.0",
 hasPermssion: 0,
 credits: "👑 𝐀𝐝𝐦𝐢𝐧 • 𝐁𝐨𝐬𝐬 𝐒𝐢𝐚𝐦 ☢️", //don't change my credit 
...
module.exports.run = async ({ api, event, args }) => {
 ...
 return api.sendMessage(`✅ 👑 𝐀𝐝𝐦𝐢𝐧 • 𝐁𝐨𝐬𝐬 𝐒𝐢𝐚𝐦 ☢️ কল বোম্বিং সম্পন্ন হয়েছে ${number} নম্বরে।`, event.threadID, event.messageID);
 } catch (error) {
